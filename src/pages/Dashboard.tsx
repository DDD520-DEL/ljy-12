...
import { ASSET_TYPE_LABELS, WILL_STATUS_LABELS, WILL_STATUS_COLORS, daysSince, formatDate } from '@/constants';
...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    {
      title: '数字遗嘱状态',
      value: WILL_STATUS_LABELS[will?.status || 'draft'],
      icon: FileText,
      color: 'from-amber-500 to-amber-600',
      subtitle: `${verifiedWitnesses}/${witnesses.length} 见证人`,
      link: '/will',
    },
    {
      title: '资产估值',
